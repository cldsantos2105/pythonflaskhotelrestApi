...
# path /hoteis?cidade=Salvador&estrelas_min=&diarias_max=400
...
class Hotel(Resource):
    ...
    atributos.add_argument('nome', type=str, required=True, help="The field 'nome' cannot be left in blank" )
